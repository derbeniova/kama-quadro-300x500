...
}).prototype = getMCSymbolPrototype(lib.car, new cjs.Rectangle(0,0,174,131), null);
...
// stage content:
(lib.kama_300x500_quadro_mt = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.car.name = "car";
	this.car.setTransform(140.05,196.45,1,1,0,0,0,90,68);
